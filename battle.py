...
def player_turn(player, mob):  # Player turn
    action = ""
...
def mob_turn(player, mob):  # Mob turn
...
def game(player):  # Main game loop
    mob = generate_mob()  # Generates the mob for the floor

    print("Floor " + str(floor))
    print("Level " + str(mob.level) + " appeared!")
